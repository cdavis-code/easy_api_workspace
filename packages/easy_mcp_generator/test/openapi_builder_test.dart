...
import 'package:easy_mcp_generator/builder/openapi_builder.dart';
  ...
  group('OpenApiBuilder', () {
    ...
    group('request/response schemas', () {
      test('generates request body schema for POST', () {
        ...
        final schema = postOp['requestBody']['content']['application/json']
            ['schema'];
    ...
    group('parameter metadata', () {
      test('includes @Parameter metadata in schema', () {
        ...
        final spec = OpenApiBuilder.build(tools, 'http', 8080, '0.0.0.0');
        final schema = spec['paths']['/users']['post']['requestBody']
    ...
    group('type mapping', () {
      test('maps String to string type', () {
        ...
        expect(
          spec['paths']['/tests']['post']['requestBody']['content']
                  ['application/json']['schema']['properties']['field']['type'],
          equals('string'),
        );
      });
